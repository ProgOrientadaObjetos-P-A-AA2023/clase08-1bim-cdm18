...
public class Principal {
    ...
    public static boolean agregarJugador() {
        ...
        if (c == null) {
            System.err.println("Debe seleccionar de forma correcta el club");
        }
    ...
    public static void verificarJugador() {
        ...
        String nombre = entrada.nextLine();
        String nombreArchivo = "data/jugadores.dat";
        LecturaSecuencialJugador archivo
                = new LecturaSecuencialJugador(nombreArchivo);
        archivo.establecerRegistroBuscado(nombre);
        
        Jugador c = archivo.obtenerRegistroBuscado();
